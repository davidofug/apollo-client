  ...
  describe('Multipart responses', () => {
    ...
    describe('subscriptions', () => {
      const subscribtionsBody = [
        ...
        'Content-Type: application/json',
        '',
        '{"data":null,"extensions":{"valueCompletion":[{"message":"Cannot return null for non-nullable field Subscription.aNewDieWasCreated","path":[]}]}}',
        '---',
        'Content-Type: application/json',
        '',
        '{"data":{"aNewDieWasCreated":{"die":{"roll":153,"sides":191,"color":"blue"}}}}',
        '---',
        'Content-Type: application/json',
        '',
        '{"data":{"aNewDieWasCreated":{"die":{"roll":107,"sides":154,"color":"red"}}}}',
        '-----',
      ].join("\r\n");
              ...
              if (i === 0) {
                expect(result).toEqual({
                  ...
                  extensions: {
                    valueCompletion: [
                      {
                        message: "Cannot return null for non-nullable field Subscription.aNewDieWasCreated",
                        path: []
                      }
                    ]
                  }
